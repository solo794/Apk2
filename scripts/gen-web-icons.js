// Generates the PWA/iOS home-screen icon set into www/icons/, reusing the exact wallet drawing
// logic from gen-icon.js (same colors/motif as the Android app icon) instead of the mismatched
// emoji-in-SVG placeholder that was in <head> before — iOS Safari doesn't support SVG
...
const { makePng, drawIcon, drawBackground, drawWallet, INK } = require("./gen-icon.js");
...
// Android/Chrome "maskable" icon: full-bleed background with the wallet kept inside the safe
